(function () {
    ...
    var onvisible = {
        ...
        add: function (selector, settings) {
            var style =
                settings.style in this.effects ? settings.style : 'fade',
                speed =
                    parseInt('speed' in settings ? settings.speed : 1000) /
                    1000,
                intensity =
                    (parseInt(
                    ...
                    0.25,
                delay =
                    parseInt('delay' in settings ? settings.delay : 0) / 1000,
